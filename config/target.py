...
class Target:
    ...
    def __repr__(self):
        return f"【bank_name: {self._bank_name}, type_main: {self._type_main}, url: {self._url}, method: {self._method}, formdata: {self._formdata}, callback: {self._callback}, selectors: {self._selectors}】"
